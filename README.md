...
> ⚠️ **版权与授权声明**
> 本仓库代码及「牛奶计算器」App 采用 **PolyForm Noncommercial License 1.0.0** 授权（见 [LICENSE](LICENSE)）。
> - ✅ 允许：个人学习、研究及一切非商业性使用（含修改与再分发，须保留本声明与作者署名）。
...
- 🏷️ App 名称随系统语言显示：中文手机显示「牛奶计算器」，英文手机显示 Milk Calculator
